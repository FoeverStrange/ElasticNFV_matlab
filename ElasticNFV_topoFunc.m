...
%                 [migFlag,migPMNo] = RandChoose_Elastic(serviceChainCell, CPUResource,MemoryResource,BandwidthResource,row,NFVNo,NFVnewMemNum,elasticNo,PMNum);  %row表示需要迁移的chain所在行数
                [migFlag,new_ServiceChain_vec] = RandChoose_Elastic_topo(new_ServiceChain_vec, CPUResource,MemoryResource,BandwidthResource,row,NFVNo,NFVnewMemNum,elasticNo,PMNum,NODE_TOPOLOGY);  %row表示需要迁移的chain所在行数
...
%                 [migFlag,migPMNo] = RandChoose_Elastic(serviceChainCell, CPUResource,MemoryResource,BandwidthResource,row,NFVNo,NFVnewbndNum,elasticNo,PMNum);  %row表示需要迁移的chain所在行数
                [migFlag,new_ServiceChain_vec] = RandChoose_Elastic_topo(new_ServiceChain_vec, CPUResource,MemoryResource,BandwidthResource,row,NFVNo,NFVnewbndNum,elasticNo,PMNum,NODE_TOPOLOGY);  %row表示需要迁移的chain所在行数
